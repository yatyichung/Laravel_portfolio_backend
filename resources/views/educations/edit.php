        ...
        <section class="w3-padding">
            ...
            <form method="post" action="/console/educations/edit/<?= $education->id ?>" novalidate class="w3-margin-bottom">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="school" name="school" id="school" value="<?= old('school', $education->school) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" name="program" id="program" value="<?= old('program', $education->program) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="date" name="start_date" id="start_date" value="<?= old('start_date', $education->start_date) ?>">
